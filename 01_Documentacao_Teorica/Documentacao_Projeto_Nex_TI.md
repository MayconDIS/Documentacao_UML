...
A aplicação foi desenvolvida inicialmente focando na versão Web ("Desktop First") para proporcionar melhor usabilidade em momentos de estudo focado, utilizando interfaces responsivas nativas em HTML5, CSS Grid e Flexbox para garantir que a plataforma se adapte perfeitamente aos smartphones da persona.
