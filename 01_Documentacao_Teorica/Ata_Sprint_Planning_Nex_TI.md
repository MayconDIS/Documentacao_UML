...
- Estruturação da versão Web (Desktop First) com CSS Grid, garantindo responsividade.
...
- O token JWT não será exposto no LocalStorage por questões de segurança (risco de XSS); a arquitetura priorizará o uso de Cookies HttpOnly para gerenciar a sessão.
