...
## ÉPICO 1: Autenticação e Gestão de Perfis

### História 1 (US01) - Realizar Login
*(Red) Prioridade: Alta*
Como usuário, quero fazer login para acessar minha conta com segurança.
*   **Critérios de Aceitação:** O sistema deve validar as credenciais. Tokens JWT devem ser gerados e gerenciados via Cookies HttpOnly (Prevenção XSS).
*   **Estimativa:** 3 Points
...
## ÉPICO 2: Jornada de Aprendizado e Flashcards
...
*   **Critérios de Aceitação:** Motor SM-2 deve calcular e atualizar os fatores de facilidade (easiness factor), intervalo e repetições com base na resposta.
...
## ÉPICO 3: Gamificação e Progressão
...
## ÉPICO 4: Suporte Acadêmico e Simulação

### História 11 (US11) - Consultar Agente IA
*(Yellow) Prioridade: Média*
Como aluno, quero consultar uma IA quando tiver dúvidas imediatas sobre o flashcard.
*   **Critérios de Aceitação:** Prompt recebe o contexto da carta. Integração via API de LLM otimizando tokens e controlando custos.
*   **Estimativa:** 8 Points
...
*   **Critérios de Aceitação:** Preferências salvas e aplicadas nas versões Web e em telas Mobile, aderindo ao padrão WAI-ARIA.
*   **Estimativa:** 5 Points
